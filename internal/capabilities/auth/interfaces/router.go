...
func RegisterAuthRoutes(r *gin.RouterGroup, service *application.AuthService, jwtUtil *auth.JWT, cfg Config, limiter *auth.Limiter, captchaVerifier contract.CaptchaVerifier) {
