...
// List 分页查询用户。tenantID 非 0 时仅返回该租户下的用户（0=平台级视角，不过滤）。
func (r *mysqlRepository) List(ctx context.Context, tenantID uint64, offset, limit int, sort, order string) ([]domain.User, int64, error) {
