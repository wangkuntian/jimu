...
## bench: 运行性能基准测试
bench:
	go test -bench=. -benchmem -run='^$$' ./internal/shared/id/... ./internal/capabilities/auth/application/... ./internal/platform/notification/... ./internal/platform/http/... ./internal/platform/queue/...
